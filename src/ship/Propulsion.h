...
public:
	...
	bool AIMatchVel2(const vector3d &vel, const vector3d &powerLimit = vector3d(1.0));
	bool AIChangeVelBy2(const vector3d &diffvel, const vector3d &powerLimit = vector3d(1.0)); // acts in object space
